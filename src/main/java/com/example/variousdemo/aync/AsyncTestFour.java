...
/**
 * @author Mark
 * @desc 使用Future和Callable实现异步demo
 */
public class AsyncTestFour {
    public static class RegisterAsyncTask{
        public FutureTask<String>  doAsyncTask(String orderCode){
            Callable<String> asyncTaskCallback = () -> {
            ...
            return new FutureTask<>(asyncTaskCallback);
        }
    }
    ...
    public static void main(String[] args) throws Exception  {
        ...
        //异步通知其他系统执行对应的动作
        FutureTask<String> futureTask = asyncTask.doAsyncTask(orderCode);
