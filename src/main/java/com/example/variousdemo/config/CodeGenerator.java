...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/hcTest?useUnicode=true&useSSL=false&characterEncoding=utf-8");
        ...
        pc.setParent("com.example.variousdemo");
        pc.setEntity("entity");
